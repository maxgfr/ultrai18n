...
const TRACKED = [
  // The corpus report is the engine measured against every fixture, regenerated
  // by `pnpm bench --ci` just above. Its thresholds are global floors; this
  // catches a single case losing sites while the floor still holds.
  "bench/report.json",
  "bench/REPORT.md",
];
